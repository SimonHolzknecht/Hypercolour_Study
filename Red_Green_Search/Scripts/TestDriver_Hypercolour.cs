    ...
    private void initiateTest() {
        ...
        if(spawnIndicators[testInstance]) {
            ...
            if(TestDriver_Hypercolour.testInstance < 15) {
                GameObject.Find("left").GetComponent<Renderer>().material.color = new Color(255,0,0,1);
                GameObject.Find("right").GetComponent<Renderer>().material.color = new Color(0,255,0,1);
            }
            else {
                GameObject.Find("right").GetComponent<Renderer>().material.color = new Color(255,0,0,1);
                GameObject.Find("left").GetComponent<Renderer>().material.color = new Color(0,255,0,1);
            }
        }
