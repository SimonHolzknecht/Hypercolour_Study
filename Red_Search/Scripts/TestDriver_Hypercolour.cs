...
{   
    ...
    private void initiateTest() {
        ...
        foreach(Firefly fly in fireflies) {
            ...
            //Apply colour
            fly.obj.GetComponent<Renderer>().material.color = colours[UnityEngine.Random.Range(1,9)];
        }
        ...
        if(spawnIndicators[testInstance]) {
            ...
            fireflies[hypercolourFlyIndex].obj.GetComponent<Renderer>().material.color = colours[0];
